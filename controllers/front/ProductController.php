...
class ProductControllerCore extends FrontController
{
    ...
    public function initContent()
    {
        ...
        if (!$this->errors) {
            ...
            $this->context->controller->addCSS(_THEME_CSS_DIR_.'my_producto.css');
            ...
            $this->context->smarty->assign(array(
                ...
                //'HOOK_HOME_CONJUNTO' => Hook::exec('productFooter', array('product' => $this->product)),
                'HOOK_HOME_CONJUNTO' => Hook::exec('displayHomeConjunto', array('product' => $this->product)),
