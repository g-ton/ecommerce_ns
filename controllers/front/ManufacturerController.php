...
class ManufacturerControllerCore extends FrontController
{
    ...
    protected function assignOne()
    {
        ...
        $nbProducts = $this->manufacturer->getProducts($this->manufacturer->id, null, null, null, $this->orderBy, $this->orderWay, true, null, null, null, $categoriaGet);
        $this->pagination((int)$nbProducts);

        $products = $this->manufacturer->getProducts($this->manufacturer->id, $this->context->language->id, (int)$this->p, (int)$this->n, $this->orderBy, $this->orderWay, null, null, null, null, $categoriaGet);
