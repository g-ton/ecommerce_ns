		...
		<div class="media heading">
			...
			<div class="cart-inner media-body">
				<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
					...
					<span class="ajax_cart_product_txt{if $cart_qties != 1} unvisible{/if}">{l s='Producto(s)' mod='blockcart'}</span>
					<span class="ajax_cart_product_txt_s{if $cart_qties < 2} unvisible{/if}">{l s='Producto(s)' mod='blockcart'}</span>
						<span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">{l s='0 Vacío' mod='blockcart'}</span>
					</div>
