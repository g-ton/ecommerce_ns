...
<div class="row addresses-lists">
	<div class="col-xs-12 col-sm-4 col-lg-4">
		<ul class="myaccount-link-list">
            ...
            <li><a href="{$link->getPageLink('pedidosFactura', true)|escape:'html':'UTF-8'}" title="Información sobre pedidos y facturas"><i class="fa fa-list-ol"></i><span>Mis Pedidos / Facturas</span></a></li>
