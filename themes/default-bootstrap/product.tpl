...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
		...
		<!-- New place of HOOK_PRODUCT_FOOTER start-->
		{if isset($HOOK_HOME_CONJUNTO) && $HOOK_HOME_CONJUNTO}{$HOOK_HOME_CONJUNTO}{/if}
		{if isset($HOOK_PRODUCT_FOOTER) && $HOOK_PRODUCT_FOOTER}{$HOOK_PRODUCT_FOOTER}{/if}
		<!-- New place of HOOK_PRODUCT_FOOTER End-->
		...
		{if isset($accessories) && $accessories}
			...
			<!--end Accessories -->
		{/if}
		<!-- Old place of HOOK_PRODUCT_FOOTER start-->
		<!-- Old place of HOOK_PRODUCT_FOOTER End-->
