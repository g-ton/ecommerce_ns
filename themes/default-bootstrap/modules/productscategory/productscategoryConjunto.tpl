...
<section class="page-product-box blockproductscategory">
	<h3 class="productscategory_h3 page-product-heading-conjunto">
		Comprados juntos habitualmente
	</h3>
	<div class="container">
		{foreach from=$categoriasDistinct item='categoryDistinct' name=categoryDistinct}
		<div id="productscategory_list" class="col-md-6" style="margin-bottom: 20px;">
				...
				<li class="product-box item">
					...
					<div class="clearfix" style="margin-top:5px">
						{if !$PS_CATALOG_MODE && ($categoryProduct.allow_oosp || $categoryProduct.quantity > 0)}
							<div class="no-print">
								<a class="exclusive button ajax_add_to_cart_button conjunto" href="{$link->getPageLink('cart', true, NULL, "qty=1&amp;id_product={$categoryProduct.id_product|intval}&amp;token={$static_token}&amp;add")|escape:'html':'UTF-8'}" data-id-product="{$categoryProduct.id_product|intval}" title="{l s='Add to cart' mod='productscategory'}">
