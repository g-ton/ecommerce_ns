...
<div class="row addresses-lists">
	<div class="col-xs-12 col-sm-6 col-lg-4">
		<ul class="myaccount-link-list">
            ...
            {/if}
            <li><a href="{$link->getPageLink('history', true)|escape:'html':'UTF-8'}" title="{l s='Orders'}"><i class="icon-list-ol"></i><span>{l s='Order history and details'}Here i am</span></a></li>
            {if $returnAllowed}
            ...
            <!-- Modificado para apartado de Pedidos Facturas ns -->
            <li><a href="{$link->getPageLink('pedidosFactura', true)|escape:'html':'UTF-8'}" title="Información sobre pedidos y facturas"><i class="icon-building"></i><span>Mis Pedidos / Facturas</span></a></li>
